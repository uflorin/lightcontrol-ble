/**************************************************************************************************
  Filename:       simpleLightControl.c
  Revised:        $Date: 2014-05-21 08:56:11 -0700  $
  Revision:       $Revision: 1 $

  Description:    This file contains the Simple Light Control app (an almost
                  direct copy of SimpleBLE Peripheral for use with the CC2540 
